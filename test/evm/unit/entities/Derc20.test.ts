...
import { Derc20 } from '../../../../src/evm/entities/token/derc20/Derc20';
import {
...
describe('Derc20', () => {
  ...
  describe('Write methods', () => {
    ...
    it('should throw error without wallet client', async () => {
      const derc20ReadOnly = new Derc20(
        publicClient,
        undefined,
        mockTokenAddress,
      );
      ...
      await expect(
        derc20ReadOnly.approve(
          '0x2345678901234567890123456789012345678901',
          parseEther('100'),
        ),
      ).rejects.toThrow('Wallet client required for write operations');

      await expect(derc20ReadOnly.release()).rejects.toThrow(
