...
export const rehypeDopplerHookAbi = [
  ...
  },
  {
    ...
    inputs: [{ name: 'poolId', type: 'bytes32', internalType: 'PoolId' }],
    outputs: [
      { name: 'assetBuybackPercentWad', type: 'uint256', internalType: 'uint256' },
      { name: 'numeraireBuybackPercentWad', type: 'uint256', internalType: 'uint256' },
      { name: 'beneficiaryPercentWad', type: 'uint256', internalType: 'uint256' },
