...
describe("BaseAuctionBuilder interface", () => {
  it("StaticAuctionBuilder implements BaseAuctionBuilder", () => {
    const builder: BaseAuctionBuilder<typeof CHAIN_IDS.BASE> = StaticAuctionBuilder.forChain(
      CHAIN_IDS.BASE,
    );
  ...
  it("DynamicAuctionBuilder implements BaseAuctionBuilder", () => {
    const builder: BaseAuctionBuilder<typeof CHAIN_IDS.BASE> = DynamicAuctionBuilder.forChain(
      CHAIN_IDS.BASE,
    );
  ...
  it("MulticurveBuilder implements BaseAuctionBuilder", () => {
    const builder: BaseAuctionBuilder<typeof CHAIN_IDS.BASE> = MulticurveBuilder.forChain(
      CHAIN_IDS.BASE,
    );
