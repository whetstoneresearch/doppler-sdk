...
maybeDescribe('Fork/Live - Multicurve NoOp Migration on Base', () => {
  ...
  it('creates multicurve auction with positive ticks (188000 to 202000)', async () => {
    ...
    if (
      !protocolOwner ||
      protocolOwner === '0x0000000000000000000000000000000000000000'
    ) {
  ...
  it('creates multicurve auction with negative ticks (-202000 to -188000)', async () => {
    ...
    const beneficiaries = [
      ...
      {
        beneficiary: '0xabcdefabcdefabcdefabcdefabcdefabcdefabcd' as Address,
        shares: (WAD * 19n) / 20n,
      }, // 95%
    ];
  ...
  it('creates multicurve auction using market cap presets', async () => {
    ...
    const beneficiaries = [
      ...
      {
        beneficiary: '0xabcdefabcdefabcdefabcdefabcdefabcdefabce' as Address,
        shares: (WAD * 19n) / 20n,
      }, // 95%
    ];
