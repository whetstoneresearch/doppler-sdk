...
/** InvalidHookProgram: Invalid prediction hook program */
export const PREDICTION_MIGRATOR_ERROR__INVALID_HOOK_PROGRAM = 0x1772; // 6002
/** InvalidHookConfig: Invalid prediction hook configuration */
export const PREDICTION_MIGRATOR_ERROR__INVALID_HOOK_CONFIG = 0x1773; // 6003
...
export const PREDICTION_MIGRATOR_ERROR__NO_PENDING_REWARDS = 0x1784; // 6020
/** ClaimableSupplyAlreadySet: Claimable supply already set */
export const PREDICTION_MIGRATOR_ERROR__CLAIMABLE_SUPPLY_ALREADY_SET = 0x1785; // 6021
/** InvalidOracleOutcome: Invalid or unregistered oracle outcome */
export const PREDICTION_MIGRATOR_ERROR__INVALID_ORACLE_OUTCOME = 0x1786; // 6022
/** MarketAlreadyResolved: Market already resolved */
export const PREDICTION_MIGRATOR_ERROR__MARKET_ALREADY_RESOLVED = 0x1787; // 6023
/** MarketIncomplete: Market has not registered all oracle outcomes */
export const PREDICTION_MIGRATOR_ERROR__MARKET_INCOMPLETE = 0x1788; // 6024
/** MarketVoided: Market is void */
export const PREDICTION_MIGRATOR_ERROR__MARKET_VOIDED = 0x1789; // 6025
/** MarketNotVoided: Market is not void */
export const PREDICTION_MIGRATOR_ERROR__MARKET_NOT_VOIDED = 0x178a; // 6026

export type PredictionMigratorError =
  | typeof PREDICTION_MIGRATOR_ERROR__CLAIMABLE_SUPPLY_ALREADY_SET
  ...
  | typeof PREDICTION_MIGRATOR_ERROR__INVALID_HOOK_CONFIG
  | typeof PREDICTION_MIGRATOR_ERROR__INVALID_HOOK_PROGRAM
  ...
  | typeof PREDICTION_MIGRATOR_ERROR__INVALID_ORACLE_OUTCOME
  | typeof PREDICTION_MIGRATOR_ERROR__INVALID_VAULT
  | typeof PREDICTION_MIGRATOR_ERROR__INVALID_WINNER_MINT
  | typeof PREDICTION_MIGRATOR_ERROR__MARKET_ALREADY_RESOLVED
  | typeof PREDICTION_MIGRATOR_ERROR__MARKET_INCOMPLETE
  | typeof PREDICTION_MIGRATOR_ERROR__MARKET_NOT_RESOLVED
  | typeof PREDICTION_MIGRATOR_ERROR__MARKET_NOT_VOIDED
  | typeof PREDICTION_MIGRATOR_ERROR__MARKET_VOIDED
...
if (process.env.NODE_ENV !== 'production') {
  predictionMigratorErrorMessages = {
    [PREDICTION_MIGRATOR_ERROR__CLAIMABLE_SUPPLY_ALREADY_SET]: `Claimable supply already set`,
    ...
    [PREDICTION_MIGRATOR_ERROR__INVALID_HOOK_CONFIG]: `Invalid prediction hook configuration`,
    [PREDICTION_MIGRATOR_ERROR__INVALID_HOOK_PROGRAM]: `Invalid prediction hook program`,
    ...
    [PREDICTION_MIGRATOR_ERROR__INVALID_ORACLE_OUTCOME]: `Invalid or unregistered oracle outcome`,
    [PREDICTION_MIGRATOR_ERROR__INVALID_VAULT]: `Invalid vault`,
    [PREDICTION_MIGRATOR_ERROR__INVALID_WINNER_MINT]: `Invalid winner mint`,
    [PREDICTION_MIGRATOR_ERROR__MARKET_ALREADY_RESOLVED]: `Market already resolved`,
    [PREDICTION_MIGRATOR_ERROR__MARKET_INCOMPLETE]: `Market has not registered all oracle outcomes`,
    [PREDICTION_MIGRATOR_ERROR__MARKET_NOT_RESOLVED]: `Market not resolved`,
    [PREDICTION_MIGRATOR_ERROR__MARKET_NOT_VOIDED]: `Market is not void`,
    [PREDICTION_MIGRATOR_ERROR__MARKET_VOIDED]: `Market is void`,
