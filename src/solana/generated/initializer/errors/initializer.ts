...
export const INITIALIZER_ERROR__INVALID_FEE_BENEFICIARY = 0x1798; // 6040
/** InvalidFeeShares: Invalid fee shares */
export const INITIALIZER_ERROR__INVALID_FEE_SHARES = 0x1799; // 6041
/** InvalidSwapFee: Invalid swap fee */
export const INITIALIZER_ERROR__INVALID_SWAP_FEE = 0x179a; // 6042
...
export type InitializerError =
  ...
  | typeof INITIALIZER_ERROR__INVALID_LAUNCH_FEE_STATE
...
if (process.env.NODE_ENV !== 'production') {
  initializerErrorMessages = {
    ...
    [INITIALIZER_ERROR__INVALID_LAUNCH_FEE_STATE]: `Invalid launch fee state`,
