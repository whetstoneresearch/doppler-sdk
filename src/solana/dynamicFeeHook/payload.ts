...
export function encodeDynamicFeeHookPayload(
  args: DynamicFeeHookPayloadArgs = {},
): Uint8Array {
...
export function getDynamicFeeHookRemainingAccounts({
  namespace,
  config,
  cosigner,
}: {
...
export function getDynamicFeeHookRemainingAccountAddresses({
  namespace,
  config,
  cosigner,
}: {
