...
export const ADDRESSES: Record<SupportedChainId, ChainAddresses> = {
  ...
  [CHAIN_IDS.BASE]: {
    ...
    v4ScheduledMulticurveInitializer: GENERATED_DOPPLER_DEPLOYMENTS[CHAIN_IDS.BASE]
  ...
  [CHAIN_IDS.BASE_SEPOLIA]: {
    ...
    v4MulticurveInitializer: GENERATED_DOPPLER_DEPLOYMENTS[CHAIN_IDS.BASE_SEPOLIA]
      .UniswapV4MulticurveInitializer as Address,
    v4ScheduledMulticurveInitializer: GENERATED_DOPPLER_DEPLOYMENTS[CHAIN_IDS.BASE_SEPOLIA]
  ...
  [CHAIN_IDS.UNICHAIN_SEPOLIA]: {
    ...
    noOpGovernanceFactory: GENERATED_DOPPLER_DEPLOYMENTS[CHAIN_IDS.UNICHAIN_SEPOLIA]
      .NoOpGovernanceFactory as Address,
    streamableFeesLocker: ZERO_ADDRESS, // Not yet deployed
  ...
  [CHAIN_IDS.MONAD_TESTNET]: {
    ...
    governanceFactory: GENERATED_DOPPLER_DEPLOYMENTS[CHAIN_IDS.MONAD_TESTNET]
      .GovernanceFactory as Address,
    noOpGovernanceFactory: GENERATED_DOPPLER_DEPLOYMENTS[CHAIN_IDS.MONAD_TESTNET]
      .NoOpGovernanceFactory as Address,
  ...
  [CHAIN_IDS.MONAD_MAINNET]: {
    ...
    governanceFactory: GENERATED_DOPPLER_DEPLOYMENTS[CHAIN_IDS.MONAD_MAINNET]
      .GovernanceFactory as Address,
    noOpGovernanceFactory: GENERATED_DOPPLER_DEPLOYMENTS[CHAIN_IDS.MONAD_MAINNET]
      .NoOpGovernanceFactory as Address,
    v4ScheduledMulticurveInitializer: GENERATED_DOPPLER_DEPLOYMENTS[CHAIN_IDS.MONAD_MAINNET]
