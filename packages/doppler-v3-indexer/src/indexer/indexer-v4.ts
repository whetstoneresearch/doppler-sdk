import { generateV4Contracts } from "@app/config/contracts/v4-contracts";
...
if (Object.keys(generateV4Contracts()).includes("UniswapV4Initializer2")) {
...
if (Object.keys(generateV4Contracts()).includes("UniswapV4Pool2")) {
