export const ZoraFactoryABI = [
  {
    type: "constructor",
    inputs: [{ name: "_coinImpl", type: "address", internalType: "address" }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "platformReferrer", type: "address", internalType: "address" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "name", type: "string", internalType: "string" },
      { name: "symbol", type: "string", internalType: "string" },
      { name: "poolConfig", type: "bytes", internalType: "bytes" },
      { name: "platformReferrer", type: "address", internalType: "address" },
      { name: "orderSize", type: "uint256", internalType: "uint256" },
    ],
    outputs: [
