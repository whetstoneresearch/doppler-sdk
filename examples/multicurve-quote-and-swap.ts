...
import { DopplerSDK, WAD, getAddresses, FEE_TIERS } from '../src/evm';
...
async function main() {
  ...
  console.log(
    '  Initial Supply:',
    formatEther(params.sale.initialSupply),
    'tokens',
  );
  console.log(
    '  For Sale:',
    formatEther(params.sale.numTokensToSell),
    'tokens',
  );
  console.log();
  ...
  const { tokenAddress, poolId, transactionHash } =
