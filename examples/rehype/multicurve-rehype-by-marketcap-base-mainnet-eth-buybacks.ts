...
async function main() {
  ...
  const params = sdk
    ...
    .withRehypeDopplerHook({
      ...
      feeRoutingMode: 1,
      feeDistributionInfo: {
        assetFeesToAssetBuybackWad: 0n, // 0%
        assetFeesToNumeraireBuybackWad: parseEther("1"), // 100%
        assetFeesToBeneficiaryWad: 0n, // 0%
        assetFeesToLpWad: 0n, // 0%
        numeraireFeesToAssetBuybackWad: 0n,
        numeraireFeesToNumeraireBuybackWad: parseEther("1"), // 100%
